...
public final class Networking {
    ...
    public static void sendSources(ServerPlayer player, List<CraftingSourceInfo> sources) {
        PacketDistributor.sendToPlayer(player, new StationPackets.CraftingSourcesPayload(sources));
    }
