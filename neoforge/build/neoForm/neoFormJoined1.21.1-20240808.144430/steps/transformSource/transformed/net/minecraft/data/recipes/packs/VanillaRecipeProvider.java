...
public class VanillaRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput) {
        ...
        colorBlockWithDye(recipeOutput, list, list1, "wool");
        colorBlockWithDye(recipeOutput, list, list2, "bed");
        colorBlockWithDye(recipeOutput, list, list3, "carpet");
        ...
        smithingTrims().forEach(p_307153_ -> trimSmithing(recipeOutput, p_307153_.template(), p_307153_.id()));
