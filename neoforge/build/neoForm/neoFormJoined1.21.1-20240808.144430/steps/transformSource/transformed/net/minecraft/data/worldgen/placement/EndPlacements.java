...
public class EndPlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        PlacementUtils.register(context, END_SPIKE, holder1, BiomeFilter.biome());
        ...
        PlacementUtils.register(
            context, CHORUS_PLANT, holder3, CountPlacement.of(UniformInt.of(0, 4)), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP, BiomeFilter.biome()
        );
        PlacementUtils.register(
            context,
