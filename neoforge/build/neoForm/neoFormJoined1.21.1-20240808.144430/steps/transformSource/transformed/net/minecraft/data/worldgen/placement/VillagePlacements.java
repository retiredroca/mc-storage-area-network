...
public class VillagePlacements {
    ...
    public static void bootstrap(BootstrapContext<PlacedFeature> context) {
        ...
        PlacementUtils.register(context, PILE_HAY_VILLAGE, holder);
        PlacementUtils.register(context, PILE_MELON_VILLAGE, holder1);
        PlacementUtils.register(context, PILE_SNOW_VILLAGE, holder2);
        PlacementUtils.register(context, PILE_ICE_VILLAGE, holder3);
        PlacementUtils.register(context, PILE_PUMPKIN_VILLAGE, holder4);
        PlacementUtils.register(context, OAK_VILLAGE, holder5, PlacementUtils.filteredByBlockSurvival(Blocks.OAK_SAPLING));
        PlacementUtils.register(context, ACACIA_VILLAGE, holder6, PlacementUtils.filteredByBlockSurvival(Blocks.ACACIA_SAPLING));
        PlacementUtils.register(context, SPRUCE_VILLAGE, holder7, PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING));
        PlacementUtils.register(context, PINE_VILLAGE, holder8, PlacementUtils.filteredByBlockSurvival(Blocks.SPRUCE_SAPLING));
        PlacementUtils.register(context, PATCH_CACTUS_VILLAGE, holder9);
        PlacementUtils.register(context, FLOWER_PLAIN_VILLAGE, holder10);
        PlacementUtils.register(context, PATCH_TAIGA_GRASS_VILLAGE, holder11);
        PlacementUtils.register(context, PATCH_BERRY_BUSH_VILLAGE, holder12);
    }
}
